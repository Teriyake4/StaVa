...
public class Match {
    private MatchData info;
    private TeamSumm redTeam;
    private TeamSumm blueTeam;
    private ArrayList<Round> rounds; // includes round summaries, damage/kill events, player round summaries
    // private ArrayList<RoundSummary> roundSummaries; // Round results and how it was won
